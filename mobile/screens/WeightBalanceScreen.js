...
const s = StyleSheet.create({
  ...
  acText:       { color: C.textMuted, fontSize: 12, fontFamily: F.semiBold },
  ...
  zoneRow:      { flexDirection: 'row', alignItems: 'center', marginBottom: 10,
                  ...
                  borderWidth: 1, borderColor: C.border },
  zoneInfo:     { flex: 1 },
  zoneLabel:    { color: '#fff', fontSize: 12, fontFamily: F.semiBold },
  zoneSub:      { color: C.textDim, fontFamily: F.regular, fontSize: 10, lineHeight: 15, marginTop: 2 },
  ...
  label:        { color: C.textMuted, fontFamily: F.semiBold, fontSize: 11, lineHeight: 16, marginBottom: 6, letterSpacing: 1 },
  ...
  bannerText:   { color: '#fff', fontSize: 13, fontFamily: F.bold, flex: 1 },
  ...
  statusLeft:   { flex: 1 },
  statusLabel:  { color: C.textMuted, fontFamily: F.semiBold, fontSize: 11, lineHeight: 16, marginBottom: 6 },
  barTrack:     { height: 8, backgroundColor: C.border, borderRadius: 4, overflow: 'hidden' },
  barFill:      { height: '100%', borderRadius: 4 },
  statusRight:  { alignItems: 'flex-end', width: 100 },
  statusValue:  { fontFamily: F.bold, fontSize: 12 },
  statusMax:    { color: C.textDim, fontFamily: F.regular, fontSize: 10, lineHeight: 15, marginTop: 2 },
  ...
  cgLegendText: { color: C.textMuted, fontFamily: F.regular, fontSize: 10, lineHeight: 15 },
  cgDetailRow:  { flexDirection: 'row', alignItems: 'center', paddingVertical: 8,
                  borderBottomWidth: 1, borderBottomColor: C.border },
  cgDetailLabel:{ color: C.textMuted, fontFamily: F.regular, fontSize: 12, lineHeight: 17, width: 70 },
  cgDetailArm:  { color: '#fff', fontFamily: F.semiBold, fontSize: 11, lineHeight: 16, width: 64 },
  cgDetailPct:  { fontSize: 12, fontFamily: F.bold, flex: 1 },
  cgNote:       { color: C.textDim, fontFamily: F.regular, fontSize: 10, lineHeight: 15, marginTop: 10, textAlign: 'center' },
  breakRow:     { flexDirection: 'row', alignItems: 'center', paddingVertical: 8,
                  borderBottomWidth: 1, borderBottomColor: C.border },
  breakLabel:   { color: C.textMuted, fontFamily: F.regular, fontSize: 12, lineHeight: 17, flex: 1 },
  breakSub:     { color: C.textDim, fontFamily: F.regular, fontSize: 10, lineHeight: 15, width: 70, textAlign: 'center' },
  breakValue:   { color: '#fff', fontFamily: F.bold, fontSize: 12,
