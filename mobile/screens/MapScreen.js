...
const s = StyleSheet.create({
  ...
  emptyText:      { color: C.green, fontFamily: F.semiBold, fontSize: 16, lineHeight: 24, textAlign: 'center' },
  ...
  legendTitle:    { color: C.textMuted, fontSize: 9, fontFamily: F.bold,
  ...
  legendText:     { color: C.textPrimary, fontFamily: F.regular, fontSize: 12, lineHeight: 17 },
  ...
  wxLabel:        { color: C.textPrimary, fontFamily: F.semiBold, fontSize: 11, lineHeight: 16 },
  // Live aircraft
  ...
  acCount:        { color: C.green, fontSize: 9, fontFamily: F.xBold,
                    backgroundColor: C.greenFaint, borderRadius: 4,
                    paddingHorizontal: 4, paddingVertical: 1 },
  refreshBtn:     { marginTop: 6, paddingVertical: 4, alignItems: 'center',
                    borderTopWidth: 1, borderTopColor: C.border },
  refreshText:    { color: C.textDim, fontSize: 10, fontFamily: F.semiBold },
  acCallout:      { position: 'absolute', bottom: 40, right: 12,
                    backgroundColor: '#0A0E1Aee', borderRadius: 12,
                    padding: 14, borderWidth: 1, borderColor: C.greenDim,
                    minWidth: 170 },
  acCalloutTitle: { color: C.green, fontFamily: F.xBold, fontSize: 14,
                    marginBottom: 10, letterSpacing: 1 },
  acCalloutRow:   { color: C.textDim, fontFamily: F.mono, fontSize: 11, lineHeight: 16, marginBottom: 5 },
  acCalloutVal:   { color: C.textPrimary, fontFamily: F.bold },
  acCalloutClose: { color: C.textDim, fontSize: 10, marginTop: 8,
                    textAlign: 'right' },
});