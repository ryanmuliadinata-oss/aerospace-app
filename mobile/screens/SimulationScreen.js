        ...
        {report.weather.map((w, i) => (
          <View key={i}>
            <View style={s.tableRow}>
              <Text style={[s.td, { flex:1, color: C.textPrimary, fontFamily: F.bold }]}>
                {w.icao}
              </Text>
      ...
      <View style={s.card}>
        ...
        {report.turbulence.map((t, i) => (
          <View key={i} style={s.turbRow}>
            ...
            <Text style={[s.td, { width:44, color: C.textPrimary, fontFamily: F.bold }]}>
              {t.icao}
            </Text>
            <Text style={[s.td, { flex:1, fontFamily: F.bold,
...
const s = StyleSheet.create({
  ...
  emptyTitle:     { color: C.textPrimary, fontSize:20, fontFamily: F.bold },
  emptySub:       { color: C.textMuted, fontFamily: F.regular, fontSize:14, lineHeight:20, marginTop:8, textAlign:'center' },
  ...
  bannerText:     { color: C.textPrimary, fontSize:14, fontFamily: F.bold, flex:1 },
  ...
  mapBtnText:     { color: C.green, fontFamily: F.bold, fontSize:13, letterSpacing:1 },
  ...
  shareBtnText:   { color: C.gold, fontFamily: F.bold, fontSize:13, letterSpacing:1 },
  ...
  cardTitle:      { color: C.textMuted, fontSize:10, fontFamily: F.bold, letterSpacing:2.5, marginBottom:14 },
  routeRow:       { flexDirection:'row', alignItems:'center',
                    justifyContent:'space-between', marginBottom:16 },
  apt:            { alignItems:'center' },
  icao:           { color: C.textPrimary, fontSize:30, fontFamily: F.xBold },
  icaoSub:        { color: C.textDim, fontSize:9, letterSpacing:2, marginTop:2 },
  routeArrow:     { color: C.textMuted, fontSize:16 },
  statsRow:       { flexDirection:'row', justifyContent:'space-around' },
  stat:           { alignItems:'center' },
  statVal:        { color: C.textPrimary, fontSize:15, fontFamily: F.bold },
  statLbl:        { color: C.textDim, fontSize:9, letterSpacing:1.5, marginTop:3 },
  tableRow:       { flexDirection:'row', paddingVertical:8,
                    borderBottomWidth:1, borderBottomColor: 'rgba(255,255,255,0.04)' },
  td:             { color: C.textSecondary, fontFamily: F.regular, fontSize:12, lineHeight:17 },
  sigmetBanner:   { backgroundColor:'#FF8C0022', borderRadius:6,
                    padding:6, marginVertical:4,
                    borderWidth:1, borderColor:'#FF8C0055' },
  sigmetText:     { color:'#FF8C00', fontSize:11, fontFamily: F.bold },
  rawMetar:       { color: C.textDim, fontFamily: F.mono, fontSize:9, lineHeight:14, marginBottom:6, paddingHorizontal:4 },
  ...
  fuelVal:        { fontSize:11, fontFamily: F.bold, width:76, textAlign:'right' },
  ...
  fuelStatusText: { color: C.textPrimary, fontFamily: F.bold, fontSize:13 },
  ...
  windRow:        { flexDirection:'row', alignItems:'center',
                    gap:10, paddingVertical:9,
                    borderBottomWidth:1, borderBottomColor: 'rgba(255,255,255,0.04)' },
  windAlt:        { color: C.green, fontFamily: F.bold, width:44 },
  windArrow:      { fontSize:16, color: C.textPrimary, width:20, textAlign:'center' },
  windSpeed:      { color: C.textPrimary, fontFamily: F.semiBold, flex:1 },
  ...
  altTitle:   { color: C.gold, fontSize:10, fontFamily: F.bold, letterSpacing:2.5, marginBottom:14 },
  altRow:     { flexDirection:'row', alignItems:'center',
                justifyContent:'space-between', paddingVertical:10,
                borderBottomWidth:1, borderBottomColor: C.border },
  altLeft:    { flex:1 },
  altIcao:    { color: C.textPrimary, fontFamily: F.xBold, fontSize:16 },
  altName:    { color: C.textMuted, fontFamily: F.regular, fontSize:11, lineHeight:16, marginTop:2 },
  altAirportReason:  { color: C.textDim, fontFamily: F.regular, fontSize:10, lineHeight:15, marginTop:2 },
  altDist:    { color: C.gold, fontFamily: F.bold, fontSize:13 },
  graphSub: { color: C.textDim, fontFamily: F.regular, fontSize:10, lineHeight:15, textAlign:'center', marginTop:6 },
  ...
  foptSavedKg:     { color: C.green, fontSize:18, fontFamily: F.xBold },
  foptOptFL:       { color: C.green, fontSize:18, fontFamily: F.xBold },
  ...
  notamHeader: { flexDirection:'row', justifyContent:'space-between',
                 marginBottom:4 },
  notamNumber: { color: C.textPrimary, fontFamily: F.bold, fontSize:12 },
  ...
  altReason: { color: C.textDim, fontFamily: F.regular, fontSize:9, lineHeight:14, textAlign:'center',
